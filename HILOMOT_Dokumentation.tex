...
\begin{titlepage}
  ...
  {\normalsize Python-Implementierung mit scikit-learn-kompatibler Schnittstelle}\[0.5em]
...
Dieses Python-Tool implementiert den HILOMOT-Algorithmus mit einer scikit-learn-kompatiblen Schnittstelle (\texttt{fit}/\texttt{predict}/\texttt{score}) und stellt sowohl eine interaktive GUI als auch eine skriptbasierte Schnittstelle bereit. Weitere verwendete Python-Bibliotheken sind \texttt{numpy}, \texttt{scipy} und \texttt{matplotlib}.
...
\begin{tabular}{p{5.5cm}p{7.5cm}}
  ...
  \texttt{save\_mat()} / \texttt{from\_mat()} & Speichern/Laden im \texttt{.mat}-Format (via \texttt{scipy.io}) \\
  \bottomrule
\end{tabular}
\end{center}
...
\begin{enumerate}
  ...
  \item \textbf{Pedregosa, F. et al.} (2011). \textit{Scikit-learn: Machine Learning in Python}. Journal of Machine Learning Research, 12, 2825--2830.\\
    Grundlegende Python-Bibliothek f"ur maschinelles Lernen; die HILOMOT-Implementierung folgt deren Estimator-Schnittstelle.
\end{enumerate}

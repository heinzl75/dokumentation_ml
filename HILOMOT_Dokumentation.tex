...
\begin{titlepage}
  ...
  {\normalsize Python-Implementierung mit scikit-learn-kompatibler API}\[0.5em]
...
Dieses Python-Tool implementiert lokale Modellnetze in reinem Python mit einer scikit-learn-kompatiblen API und stellt sowohl eine interaktive GUI als auch eine skriptbasierte Schnittstelle bereit.
...
\begin{tabular}{p{5.5cm}p{7.5cm}}
  ...
  \texttt{joblib.dump()} / \texttt{joblib.load()} & Speichern/Laden mit \texttt{joblib} (Python-Standard) \\
  \bottomrule
\end{tabular}
\end{center}
...
\begin{enumerate}
  ...
  \item \textbf{Pedregosa, F. et al.} (2011). \textit{Scikit-learn: Machine Learning in Python}. Journal of Machine Learning Research, 12, 2825--2830. \url{https://scikit-learn.org}
\end{enumerate}

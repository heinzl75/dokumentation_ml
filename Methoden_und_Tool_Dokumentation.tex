...
\item \textbf{Implementierung:} Die konkrete Umsetzung im Python-Tool \emph{LMNTool Multi GUI}
      wird beschrieben, einschlie\ss{}lich aller relevanten Hyperparameter und ihrer Wirkung.
...
\item[Kapitel~9] LMNTool Multi GUI -- Datenimport, Parameter, Visualisierungen, Export.

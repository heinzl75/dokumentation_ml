...
\item[Kapitel~9] L2ML-Fitting-Tool -- Python-Vergleichswerkzeug, Datenimport, Parameter, Visualisierungen, Export.
...
\begin{merkbox}
\textbf{Einordnung:} W\"{a}hrend das \emph{L2ML-Fitting-Tool} (Kapitel~9) ein
...
\section{Vergleich mit dem Python L2ML-Fitting-Tool}
